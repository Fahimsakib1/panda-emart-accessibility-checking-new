...
fs.readFile('../index.html', 'utf8', (err, data) => {
    ...
    // Total improper src extension for an image
    // if (totalInvalidSrcExtensionCount.length > 0) {
    //     console.log('\n')
    //     console.log("Total inappropriate src extension in images :", totalInvalidSrcExtensionCount.length);
    //     totalInvalidSrcExtensionCount.forEach(singleImage => {
    //         console.log(singleImage);
    //     });
    //     console.log("#### Solution: Add proper src extension like: jpg, png, webp, jpeg, etc,")
    // } else {
    //     console.log('\n')
    //     console.log("No Image found that has src extension related issue.");
    // }
